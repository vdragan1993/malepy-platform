...
class Assignment(models.Model):
    ...
    folder = models.CharField(max_length=100, null=False, blank=False, default='new_folder')
    training = models.FileField(null=False, blank=False, upload_to=assignment_data_set_directory)
